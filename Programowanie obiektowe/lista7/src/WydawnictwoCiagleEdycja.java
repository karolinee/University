...
public class WydawnictwoCiagleEdycja extends JFrame implements ActionListener, Serializable {
    private Ksiazka k;
    ...
    public WydawnictwoCiagleEdycja(String name){
        ...
        frame = new JFrame("Edycja wydawnicta ciągłego");
